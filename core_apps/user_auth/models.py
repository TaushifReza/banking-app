...
class User(AbstractUser):
    ...
    class RoleChoices(models.TextChoices):
        ...
        ACCOUNT_EXECUITIVE = "account_execuitive", _("Account Execuitive")
    ...
    first_name = models.TextField(_("First Name"), max_length=30)
    middle_name = models.TextField(
        _("Middle Name"), max_length=30, blank=True, null=True
    )
    last_name = models.TextField(_("Last Name"), max_length=30)
